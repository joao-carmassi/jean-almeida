...
O **burnout** é um estado de esgotamento físico e mental relacionado ao trabalho. Ele pode surgir quando a pessoa passa muito tempo exposta a cobranças intensas, excesso de responsabilidades, pressão constante, falta de reconhecimento ou dificuldade de se desconectar das demandas profissionais.
...
- o burnout persiste mesmo após descanso;
...
Esses sintomas são reais e não devem ser tratados como frescura ou falta de força de vontade. Porém, sintomas físicos intensos, novos ou persistentes devem ser avaliados por um médico para descartar outras causas.
...
Sim. O burnout pode estar associado a sintomas de ansiedade e depressão, especialmente quando o esgotamento se prolonga por muito tempo.

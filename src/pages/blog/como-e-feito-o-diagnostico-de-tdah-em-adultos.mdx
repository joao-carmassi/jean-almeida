...
O objetivo não é transformar a pessoa em alguém diferente, mas reduzir prejuízos e melhorar qualidade de vida. As opções de [tratamento para TDAH em adultos](/blog/tratamento-para-tdah-em-adultos/), incluindo quando a medicação costuma ser considerada, são detalhadas em outro texto. O TDAH apresenta forte componente genético, sendo comum existir histórico familiar.

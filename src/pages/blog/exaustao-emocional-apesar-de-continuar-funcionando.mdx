...
A **exaustão emocional apesar de continuar funcionando** é uma situação mais comum do que parece. A pessoa trabalha, responde mensagens, cumpre prazos, cuida da casa, estuda e parece estar dando conta. Por fora, tudo parece normal. Por dentro, existe cansaço, irritação, vazio e sensação de estar no limite.
...
Mesmo assim, apenas um profissional pode avaliar se é burnout, ansiedade, depressão, estresse crônico ou outro quadro.

...
Se você ainda está em dúvida se é o momento de marcar, o passo anterior a este é reconhecer os sinais: reunimos em outro texto [como saber se você precisa de um psiquiatra](/blog/como-saber-se-preciso-de-um-psiquiatra/).
...
Antes do agendamento, vale ainda resolver a parte prática: duração do atendimento, política de retorno e [quanto custa uma consulta com psiquiatra](/blog/quanto-custa-uma-consulta-com-psiquiatra/) na modalidade escolhida. Saber disso com antecedência evita surpresas e ajuda a planejar o acompanhamento.

...
O que diferencia a depressão de uma tristeza comum não é apenas a duração, mas também a intensidade e o impacto na vida diária. Esses três critérios são o eixo do texto sobre [depressão ou tristeza: como diferenciar](/blog/depressao-ou-tristeza-como-diferenciar/), útil para quem ainda está em dúvida sobre o que está vivendo.
...
Em qualquer situação, sintomas prolongados merecem avaliação profissional. Mesmo quando a pessoa já se acostumou a viver assim, existe possibilidade de tratamento e melhora. Nesses quadros mais arrastados, revisar a lista de [sintomas de depressão](/blog/sintomas-de-depressao/) ajuda a perceber sinais que passaram a parecer parte da personalidade.
...
Buscar ajuda cedo é uma das formas mais importantes de reduzir o tempo de sofrimento e prevenir recaídas. Para entender o que envolve esse acompanhamento, veja como funciona o [tratamento para depressão](/tratamentos/depressao/).

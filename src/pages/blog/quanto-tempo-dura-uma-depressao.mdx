...
A duração de uma depressão varia bastante. Algumas pessoas melhoram em algumas semanas ou meses com acompanhamento adequado. Outras podem ter sintomas por períodos mais longos, especialmente quando o quadro é grave, recorrente ou não recebe tratamento.
